...
# read the dataset
dt <- fread('/Users/Sotiris/Desktop/efood.csv', sep=',', encoding = 'UTF-8')
...
fwrite(rbindlist(l = list(per_user_above_threshold, per_user_below_threshold)), '/Users/Sotiris/Desktop/efood_clusters.csv')